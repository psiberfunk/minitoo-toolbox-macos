...
final class DivoomDaemon {
    ...
    func sendPacket(_ pkt: Data) throws {
        ...
        // Bluetooth-stack instability at the time — see PROTOCOL.md/project
        // notes. Retested cleanly afterward: screen on/off both directions
        // and a real multi-packet image transfer with a genuine device ACK
        // all worked correctly through this exact code path.)
