# Install Divoom MiniToo

1. Download and open `Divoom-MiniToo-macos-universal.dmg`.
2. Drag **Divoom MiniToo.app** to **Applications**.
...
It removes macOS's download-quarantine attribute from Divoom MiniToo only; it
